...
export default function Home() {
  return (
    <main className="paper-grain relative min-h-[100svh] w-full overflow-hidden bg-[color:var(--color-paper)]">
      ...
      <div className="flex min-h-[100svh] w-full items-stretch justify-center md:items-center md:px-6 md:py-20">
        <div
          className="relative h-[100svh] w-full overflow-hidden bg-black
            md:aspect-[9/16] md:h-[min(86svh,880px)] md:w-auto
            md:rounded-[var(--radius-frame)] md:shadow-[var(--shadow-frame)]"
        >
          <Viewfinder />
